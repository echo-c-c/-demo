...
#### 语音模式使用流程
1. **切换到语音模式**：点击"🎤 切换到语音模式"按钮
2. **开始录音**：点击"🎤 开始录音"按钮开始语音输入
3. **结束录音**：点击"⏹️ 结束录音"按钮结束语音输入
4. **播放回复**：点击"▶️ 播放最新回复"按钮播放AI回复语音
5. **停止播放**：点击"⏹️ 停止播放"按钮终止当前播放
6. **切换模式**：点击"📝 切换到文本模式"返回文本模式

#### 技术实现
- 使用七牛云语音服务进行ASR语音识别和TTS语音合成
- WebSocket实时通信，低延迟语音交互
- 智能降级机制，确保功能稳定性
- 完整的播放控制，支持播放/停止切换
...
4. **语音功能无法使用**
   ...
   - 语音模式切换：确保点击"切换到语音模式"后再开始录音
   - 播放控制：使用"播放最新回复"按钮播放AI回复语音
